...
export async function sendMessage(input: { clientId: string; text: string }) {
  ...
  }).select("id,cliente_id,sender,text,type,read_at,created_at,time,seq,doc_name,duration").single();
