...
const configurableKeys=new Set(["timer_config","radar_fiscal_config","radar_fiscal_clientes","triagem_config","triagem_regras","triagem_assuntos","nfse_config","nota_fiscal_config","ia_skills","chat_appearance","chat_shortcuts","copilot_shortcuts","area_cliente_config","painel_preferencias","tarefas","hero_banner_config"]);
