...
export type ClientMessage = Pick<Tables["mensagens"]["Row"],
  "id" | "cliente_id" | "sender" | "text" | "type" | "read_at" | "created_at" | "time" | "seq" | "doc_name" | "duration" | "transcricao" | "canal" | "wa_status"
>;
